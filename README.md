...
Cet historique devra être accessible sur simple demande de l'administrateur.
...
Du fait des données sensibles manipulées par la société, le client requiert d'avoir son propre serveur vocal à l'instar de Google, mais sur un modèle privé et gratuit. L'avantage d'avoir son propre serveur est que la gestion est locale, les accès sont contrôlés uniquement par des personnes autorisées. Le logiciel retenu est Mumble.

<h2 id="Membres du groupe de projet">Membres du groupe de projet</h2>

Le projet Mumble est composé de Mindy Sétham et d'Anthony Vidal. 

Pour rappel, voici les responsabilités et rôles de ces deux postes: 

Le **Product Owner** veille à la satisfaction des demandes du client, c'est un chef de projet en mode agile, c'est à dire qu'il va chercher à changer et améliorer continuellement le projet jusqu'à satisfaction finale du client. Il fait la liaison entre les différentes parties qui composent le projet.  
...
|---  |:-:  |:-:  |
|  DEBIAN  | **Stabilité :** système très stable et fiable, idéal pour des serveurs à long terme</br> **Performances :** meilleures performances que Windows</br> **Contrôle :** contrôle total du serveur (optimisation, gestion des permissions…)</br> **Sécurité :** sécurité excellente et mise à jour souvent rapides et faciles</br> **Coût :** Gratuit et open-source | **Connaissance de Linux :** ligne de commande, gestion des services etc.. |  
|  WINDOWS |  **Facilité d’installation :** utilise un installateur graphique, pas besoin de ligne de commande</br> **Compatibilité :** sous windows le logiciel peut être compatible avec d’autres applications (jeux, logiciel de gestion etc..)</br>**Interface graphique :** gestion du serveur plus facile pour un utilisateur non technique   |  **Performance :** Windows est plus gourmand en ressources qu’un serveur Linux</br> **Coût :** nécessite l’achat d’une licence Windows</br> **Optimisation :** moins optimisé pour les services de fond (mumble est un service de fond)</br> **Sécurité :** moins sûr qu’un serveur Linux pour un hébergement à long terme  |
...
À la mi-deuxième semaine, nous avons pris la décision de ne plus tester et de mieux nous concentrer sur la recherche d'informations, la documentation et les vidéos explicatives sur l'installation et l'utilisation du logiciel. Cela nous a permis de regrouper les meilleures informations pour terminer le projet de documentation dans les délais.  
